...
export const Slider2 = ({ onChange, value }: { onChange: (value: Point2) => void, value: Point2 }) => {
  ...
  return (
    <div className="mt-4 mb-4 ml-6 mr-6">
      <div className="bg-secondary p-4">
        <svg ref={svgRef} className="cursor-pointer overflow-visible" xmlns="http://www.w3.org/2000/svg" viewBox={[0, 0, width, height].join(' ')}>
